      ...
      <div class="page-header__wrapper page-header__wrapper--top">
        ...
        <div class="page-header__center page-header__center--top">
          ...
          <a class="logo logo--header" href="#">
            <svg width="76" height="24" aria-label="Логотип">
    ...
    <div class="menu">
      <div class="menu__wrapper menu__wrapper--top">
        <nav class="navigation navigation--menu-left" role="navigation">
          ...
          <div class="phone phone--menu-mobile">
            <h6>
              Телефон для бронирования
            </h6>
      ...
      <div class="menu__wrapper menu__wrapper--bottom">
        <div class="menu__left">
          <div class="phone phone--menu-individual">
            <h6>
            ...
            <a href="mailto:premium@vodohod.ru">
              premium@vodohod.ru
            </a>
          </div>
        </div>
        <div class="menu__center">
          <ul class="social social--menu">
            <li class="social__item">
              <a class="button button--social-menu" href="" target="_blank">
        ...
        <div class="menu__right">
          <div class="phone phone--menu-corporation">
            <h6>
              Для корпоративных заказчиков:
            </h6>

            <a href="mailto:corp@vodohod.ru">
              corp@vodohod.ru
            </a>
            <a href="tel:+74951504637">
              +7 (495) 150-46-37
            </a>
          </div>
        </div>
